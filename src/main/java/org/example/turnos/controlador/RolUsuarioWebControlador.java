...
public class RolUsuarioWebControlador {
    ...
    // Buscar un rol-usuario por role
    @GetMapping("/buscar-por-role")
    public String buscarPorRole(@RequestParam String role, Model model) {
        RolUsuarioDTO rol = rolUsuarioServicio.traerRolUsuarioPorRole(role);
